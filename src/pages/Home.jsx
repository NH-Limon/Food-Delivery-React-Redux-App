    ...
    <Helmet title="Home">
          ...
          <Row>
            <Col lg="6" md="6">
              <div className="hero__content">
                <h5 className="mb-3">
                  Get Your Food Faster With Us <br />
                  <br /> Easy food delivery service is here
                </h5>
                <h1 className="mb-4 hero__title">
                  <span>Feeling hungry?</span>
                </h1>

                <p>Here Is Our Best Food Delivery Ordering App For You</p>

                <div className="hero__btns d-flex align-items-center gap-5 mt-4">
                  <button className="order__btn d-flex align-items-center justify-content-between">
                    Order Foods <i className="ri-arrow-right-s-line"></i>
                  </button>
        ...
        <Container>
          <Row>
            <Col lg="12" className="text-center">
              <h5 className="feature__subtitle mb-4">What We Are Providing</h5>
      ...
      <section className="why__choose-us">
        <Container>
          <Row>
            <Col lg="6" md="6">
              <img src={whyImg} alt="why-Hungry" className="w-100"></img>
            </Col>
            <Col lg="6" md="6">
              <div className="why__Hungry">
                <h2 className="Hungry-title mb-2">
                  Why <span>Hungry?</span>
                </h2>
                <p className="Hungry-desc">
